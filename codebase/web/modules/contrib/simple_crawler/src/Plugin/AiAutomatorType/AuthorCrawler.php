 ...
 */
#[AiAutomatorType(
  id: 'simple_crawler_author_string',
  label: new TranslatableMarkup('Simple Crawler: Author Crawler'),
  field_rule: 'string',
  target: '',
)]
class AuthorCrawler extends CrawlerBase implements AiAutomatorTypeInterface {

  /**
   * {@inheritDoc}
   */
  public $title = 'Simple Crawler: Author Crawler';
  ...
  public function generate(ContentEntityInterface $entity, FieldDefinitionInterface $fieldDefinition, array $automatorConfig) {
    ...
    foreach ($uris as $uri) {
      ...
      $values[] = $done ? $readability->getAuthor() : '';
    }
    return $values;
  }
