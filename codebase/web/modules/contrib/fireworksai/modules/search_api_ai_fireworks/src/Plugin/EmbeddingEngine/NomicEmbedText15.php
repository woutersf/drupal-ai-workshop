 ...
 */
#[EmbeddingEngine(
  id: 'fireworks_nomic_embed_text_15',
  label: new TranslatableMarkup('Fireworks Nomic Embed Text 1.5'),
  description: new TranslatableMarkup('Fireworks Nomic Embed Text 1.5. Recommended by Fireworks AI.'),
  dimension: 768,
)]
final class NomicEmbedText15 implements EmbeddingEngineInterface {
  ...
  public function generateEmbeddings(string $text, array $options = []): array {
    ...
    $response = json_decode($this->client->embeddingsCreate('nomic-ai/nomic-embed-text-v1.5', $text, $options), TRUE);
